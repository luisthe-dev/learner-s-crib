...
if(isset($_POST['Search_Item'])){
    ...
    $Search = mysqli_real_escape_string($LearnersCribResource, $_POST['Search_Item']);

    $Material_Query = "SELECT * FROM materials WHERE ( File_Name LIKE '%$Search%' OR File_Description LIKE '%$Search%' OR Course_Code LIKE '%$Search%' OR Course_Title LIKE '%$Search%') AND Is_Deleted = 0";
